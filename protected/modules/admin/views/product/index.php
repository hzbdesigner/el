	...
	<div class="container">
		<div class="row tabbable tabs-left">
				...
				<ul class=" span2 nav nav-pills nav-stacked">
					<li class="<?php if( $this->action->id=='admin'){ echo 'active';} ?>"> <a href="<?php echo $this->createUrl('/admin/product/admin') ; ?>" >产品管理</a> </li>
					<li class="<?php if( $this->action->id=='create'){ echo 'active';} ?>"> <a href="<?php echo $this->createUrl('/admin/product/create') ; ?>"  >添加产品</a> </li> 
				</ul>
				<div class="span10">
